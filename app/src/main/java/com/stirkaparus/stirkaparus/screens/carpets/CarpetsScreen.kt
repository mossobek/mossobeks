...
fun CarpetsScreen(navController: NavController) {
    ...
    if (carpetAlertDialogState) AddCarpetAlertDialog(
        id = id.toString(), viewModel = viewModel,
        onClick = {
...
fun AddCarpetAlertDialog(
    ...
    onClick: () -> Unit, onDismiss: () -> Unit, price: Int = 120
                            ...
                            Button(
                                modifier = Modifier
                                    ...
                                    if (sideB.value != "" && sideB.value != "") {
                                        ...
                                        viewModel.addCarpet(carpet = carpet,
                                            success = {
